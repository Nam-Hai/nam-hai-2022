  ...
  constructor() {
    ...
    this.collectionsInfo = [
      ...
      },
      {
        ...
        detailHTML: `
        <div class="detail__img__container cI" style="aspect-ratio: 111/86"><img src="detail/d5_1.png" alt="jesperish__img-1"></div>
        <div class="detail__img__container" style="aspect-ratio: 148/215"><img src="detail/d5_2.png" alt="jesperish-2"></div>
        <div class="detail__img__container" style="aspect-ratio: 444/281"><img src="detail/d5_3.png" alt="jesperish-3"></div>
        <div class="detail__img__container gI" style="aspect-ratio: 888/1031"><img src="detail/d5_4.png" alt="jesperish-4"></div>
        <div class="detail__img__container" style="aspect-ratio: 148/215"><img src="detail/d5_5.png" alt="jesperish-5" ></div>
        <div class="detail__img__container" style="aspect-ratio: 148/215"><img src="detail/d5_6.png" alt="jesperish-6" ></div>
        <div class="detail__img__container" style="aspect-ratio: 148/215"><img src="detail/d5_7.png" alt="jesperish-7" ></div>`,
        'dF': 'Digital Painting',
        'dN': 'Jesperish'
      },
      {
        ...
        detailHTML: `
        <div class="detail__img__container" style="aspect-ratio: 1/1"><img src="detail/d4_1.png" alt="cherifkid_image-1"></div>
      ...
      },
      {
        ...
        detailHTML: `
        <div class="detail__img__container ggI" style="aspect-ratio: 2/1"><img src="detail/d6_1.png" alt="raegular-1"></div>
        <div class="detail__img__container" style="aspect-ratio: 4/5"><img src="detail/d6_2.jpg" alt="raegular-2"></div>
        <div class="detail__img__container" style="aspect-ratio: 4/5"><img src="detail/d6_3.jpg" alt="raegular-3"></div>
        <div class="detail__img__container " style="aspect-ratio: 4/5"><img src="detail/d6_4.jpg" alt="raegular-4"></div>
        <div class="detail__img__container" style="aspect-ratio: 4/5"><img src="detail/d6_5.jpg" alt="raegular-5" ></div>
        <div class="detail__img__container cI" style="aspect-ratio: 1/1"><img src="detail/d6_6.jpg" alt="raegular-6" ></div>`,
        'dF': 'Graphist',
        'dN': 'Raegular'
      },
      {
        ...
        <div class="detail__img__container cI"style="aspect-ratio: 1/1"><img src="detail/d3_5.png" alt="midjourney-5"></div>
        ...
        detailHTML: `
        <div class="detail__img__container" style="aspect-ratio: 1/1"><img src="detail/d7_1.webp" alt="jardel-1"></div>
        <div class="detail__img__container" style="aspect-ratio: 1/1"><img src="detail/d7_2.webp" alt="jardel-2"></div>
        <div class="detail__img__container ggI" style="aspect-ratio: 1/1"><img src="detail/d7_3.webp" alt="jardel-3"></div>
        <div class="detail__img__container"style="aspect-ratio: 1/1"><img src="detail/d7_4.webp" alt="jardel-4"></div>
