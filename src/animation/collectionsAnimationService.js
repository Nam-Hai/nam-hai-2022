  ...
  constructor() {
    ...
    this.collectionsInfo = [
      ...
      },
      {
        ...
        detailHTML: '<div class="detail__img__container cI"><img src="detail/d5_1.png" alt="jesperish__img-1"></div><div class="detail__img__container"><img src="detail/d5_2.png" alt="jesperish-2"></div><div class="detail__img__container"><img src="detail/d5_3.png" alt="jesperish-3"></div><div class="detail__img__container gI"><img src="detail/d5_4.png" alt="jesperish-4"></div><div class="detail__img__container"><img src="detail/d5_5.png" alt="jesperish-5" ></div><div class="detail__img__container"><img src="detail/d5_6.png" alt="jesperish-6" ></div><div class="detail__img__container"><img src="detail/d5_7.png" alt="jesperish-7" ></div>',
        'dF': 'Digital Painting',
        'dN': 'Jesperish'
      },
